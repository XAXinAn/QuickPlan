...
interface LargeModelService {
     ...
     * @return A ModelResponse object containing the extracted deadline date, time, and notification content.
     * @throws Exception if an error occurs during the API call or response parsing.
     */
    suspend fun processImage(base64Image: String, prompt: String): ModelResponse
}
